...
import { UserPen, SearchCheck, Handshake } from "lucide-react";
  ...
  return (
    <>
      <div
        ...
        <Card title="Choose the skills you want, and the skills you want to offer" icon={<UserPen className="size-20"/>}>
          <CanvasRevealEffect animationSpeed={5.1} containerClassName="bg-emerald-900" />
        </Card>
        <Card title="Get in touch with your perfect teach and student at once" icon={<SearchCheck className="size-20"/>}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Communicate with each other, Teach and Learn from one another at the same time" icon={<Handshake className="size-20" />}>
          <CanvasRevealEffect
            animationSpeed={3}
