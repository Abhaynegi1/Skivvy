...
const Teach = () => {
  ...
  // Profiles data
  const profiles = [
    { name: "user 1", s: "Writing", s1: "Singing", rating: 4.2, duration: 1 },
    { name: "user 2", s: "Graphic designing", s1: "Web Development", rating: 3.8, duration: 3 },
    { name: "user 3", s: "Web Development", s1: "Gaming", rating: 4.9, duration: 6 },
    { name: "user 4", s: "Guitar", s1: "Graphic Designing", rating: 2.5, duration: 12 },
    { name: "user 5", s: "video Editing", s1: "Programming", rating: 4.5, duration: 9 },
  ];
  ...
  return (
    <div className="flex justify-center mt-20 p-5 flex-wrap gap-10 bg-orange-200">
      {/* FILTERS SECTION */}
        ...
        <div className="main space-y-4">
          {filteredProfiles.length > 0 ? (
            filteredProfiles.map((p, index) => (
              ...
              >
                <Profiles name={p.name} s={p.s} s1={p.s1} duration={p.duration} label='Seeking:'/>
              </div>
            ))
          ) : (
